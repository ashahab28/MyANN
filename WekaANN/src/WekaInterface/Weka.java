...
public class Weka {
    ...
    public void runCV(boolean summary) throws Exception{
        ...
        m_Evaluation.crossValidateModel(m_Classifier, filtered, 6, getM_Training().getRandomNumberGenerator(1));
    ...
    public static void main(String[] args) throws Exception{
        ...
        weka.setTraining("weather.numeric.arff");
        
        String[] options_cl = {""};
        weka.setClassifier("myPerceptron.SinglePerceptron", options_cl);
